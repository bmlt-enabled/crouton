    ...
    class TableAdmin
    {
        ...
        public function enqueueBackendFiles($hook)
        {
            if (str_ends_with($hook, $this->hook)) {
                ...
                wp_enqueue_script("crouton-localization", plugin_dir_url(__DIR__) . "croutonjs/src/js/crouton-localization.js", array('jquery'), filemtime(plugin_dir_path(__DIR__) . "croutonjs/src/js/crouton-localization.js"), true);
        ...
        public function adminOptionsPage()
        {
            ...
            if ($_POST['bmlttabssave']) {
                ...
                $options['custom_translations'] = isset($_POST['custom_translations']) ? wp_specialchars_decode(wp_kses(wp_unslash($_POST['custom_translations']), true)): '';
            ...
            <div class="wrap">
                ...
                <form style="display:inline!important;" method="POST" id="bmlt_tabs_options" name="bmlt_tabs_options">
                    ...
                    <nav class="nav-tab-wrapper">
                        ...
                        <a href="#crouton-translations" class="nav-tab"><?php esc_html_e('Translations', 'crouton') ?></a>
                    </nav>
                    ...
                    <div id="crouton-templates">
                        <div id="examplePopup1" style="display:none">
                            <h2>Database Fields in BMLT Root Server</h2>
                            <table id="fields_table"></table>
                        ...
                        <div style="padding: 0 15px;" class="postbox">
                            ...
                            <p><?php esc_html_e('This allows customization of the first column of the meeting list table.  A list of available fields are', 'crouton') ?>
                                <span style="text-align:center;padding:20px 0;">
                                    <input alt="#TB_inline?height=300&amp;width=400&amp;inlineId=examplePopup1" title="Show Handlebar Variables" class="thickbox" type="button" value="<?php esc_html_e('here', 'crouton') ?>" /></span>.
                            </p>
