        ...
        */
        public function enqueueFrontendFiles()
        {
            if ($this->hasShortcode()) {
                ...
                wp_enqueue_style('query-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/' . $wp_scripts->registered['jquery-ui-core']->ver . '/themes/base/jquery-ui.css', false, PLUGIN_VERSION, false);
