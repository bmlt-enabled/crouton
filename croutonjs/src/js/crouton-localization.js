...
"en-AU": {
		...
		"fa-IR": {
			"days_of_the_week" : ["", 'یکشنبه', 'دوشنبه', 'سه‌شنبه', 'چهارشنبه', 'پنج شنبه', 'جمعه', 'شنبه'],
			"weekday" : "ایام هفته",
			"city" : "شهر",
			"cities" : "شهرها",
			"groups" : "گروه ها",
			...
			"map" : "نقشه",
			"neighborhood": "محله",
			"near_me": "جستجوی جلسات نزدیک من",
			"text_search": "پیدا کردن جلسات انجا",
			"click_search": "یافتن جلسات نزدیک به یک نقطع روی نقشه",
			"pan_and_zoom": "زوم + حرکت",
			"languages": "زبانها",
			"common_needs": "نیازهای مشترک",
			"meeting_count": "جلسات هفتگی:",
			"venue_types": "انواع مکان برگزاری",
			"venue_type_choices": {
				IN_PERSON: "حضوری",
				VIRTUAL: "مجازی",
			},
			"service_body_types": {
				AS: "کمیته خدماتی منطقه",
			...
			"share": "اشتراک گذاری",
			'google_directions': 'مسیرهای گوگل برای جلسات',
			'apple_directions': 'مسیرهای اپل برای جلسات',
			"no_meetings_for_this_day": "جلسه ای برای این روز نیست",
			"css-direction": 'bmlt-rtl',
			'all': 'همه',
			'menu': "منو",
			'search for meetings': 'جستجو برای جلسات',
			'show meetings near...': 'مشاهده جلسات نزدیک من...',
			'filter meetings': 'فیلتر جلسات',
			'visible meeting list': 'لیست کردن جلسات قابل مشاهده',
			'enter a city or zip code': 'اسم شهر یا کد پستی خود را وارد کنید',
			'toggle fullscreen mode': 'تغییر به حالت تمام صفحه',
			'close': "بسته",
			"bmlt2ics": "به تقویم خود اضافه کنید",
			'meeting page': "صفحه جلسات",
			'meeting details': "جزییات جلسات",
			'report update': "گزارش بروزرسانی",
			'filter by visibility': "فقط این جلسات را فهرست کن",
			'go': "برو!",
			"distance": "فاصله",
			"get_directions": "دریافت مسیر",
			"select_map_app": "انتخاب مسیریاب",
			"apple_maps": "نقشه اپل",
			"apple_maps_desc": "باز کردن در برنامه نقشه اپل",
			"google_maps": "گوگل مپ",
			"google_maps_desc_mobile": "باز کردن در برنامه گوگل مپ",
			"waze": "ویوز",
			"waze_desc": "باز کردن در برنامه ویوز",
