...
Contributors: bmltenabled, odathp, otrok7, radius314, pjaudiomv, californiasteve9390, alanb2718, jbraswell
...
= 4.3.2 =
* Add autocomplete to geosearch dialog

= 4.3.1 =
* Bump version for npm fix.
...
= 4.1.11 =
* Allow configuration of starting location for map in embedded maps.
...
* Use pipe(|) instead of comma to denote and-ed formats in shortcode
...
= 4.1.3 =
* Bug fix when filter_visible=0

= 4.1.2 =
* Select language from dropdown rather than entering it.

= 4.1.1 =
* Added Package.json back into dist
...
= 4.0.4 =
* Version bump for croutonjs again

= 4.0.3 =
* Version bump for croutonjs
...
= 3.24.1 =
* Make it easier for sites to start using distance sort.

= 3.24.0 =
* Sort by Distance works for [bmlt_tabs] shortcode.
...
* Use partial {{> meetingDetailsButton this}} to generate button.
